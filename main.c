...
struct workqueue_struct *http_server_wq;
...
static int __init khttpd_init(void)
{
    ...
    http_server_wq = alloc_workqueue(MODULE_NAME, 0, 0);
    http_server = my_kthread_run(http_server_daemon, &param, KBUILD_MODNAME);
